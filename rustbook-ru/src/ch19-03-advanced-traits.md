...
<span class="caption">Листинг 19-23: Создание типа <code>Wrapper</code> вокруг типа <code>Vec<string></string></code> для реализации типажа <code>Display</code></span>
