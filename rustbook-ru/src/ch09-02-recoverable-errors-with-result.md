...
Напомним из ["Обработка потенциального сбоя с помощью типа `Result`"] главы 2, перечисление `Result`, имеющее два варианта, `Ok` и `Err`, определено следующим образом:
